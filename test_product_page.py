...
@allure.story("для зарегистрированного пользователя")
class TestUserAddToBasketFromProductPage:
    ...
    @allure.step("Пользователь должен увидеть сообщение о добавлении товара")
    ...
    @allure.step("Добавим товар в корзину и вычислим спец.код для задания")
    @pytest.mark.need_review
